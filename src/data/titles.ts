...
export const titles: Title[] = [
  ...
  },
  {
    ...
    condition: (evaluation) => 
      evaluation.rizz >= 70 && evaluation.abstract >= 60 && evaluation.npcEnergy < 40,
    advice: [
      '你的社交能力已经很强了，保持这种平衡',
      '适当的幽默感让你更有魅力',
      '继续保持对不同社交场景的敏感度',
  ...
  },
  {
    ...
    condition: (evaluation) => 
      evaluation.abstract >= 80 && evaluation.rizz < 50,
    advice: [
      '考虑一下受众，不是所有人都懂梗',
      '在正式场合收敛一下抽象程度',
      '保持个性很好，但也要学会切换模式',
  ...
  },
  {
    ...
    condition: (evaluation) => 
      evaluation.npcEnergy >= 60 && evaluation.rizz < 40,
    advice: [
      '多观察社交场景中的气氛',
      '学习一些基本的社交话术',
      '不要害怕表达，沉默不一定是最好的选择',
  ...
  },
  {
    ...
    condition: (evaluation) => 
      evaluation.rizz >= 50 && evaluation.toxic < 30 && evaluation.abstract < 40,
    advice: [
      '保持这份真诚，但也可以学点技巧',
      '适度的幽默感会让你更有魅力',
      '真诚是你的优势，不要轻易改变',
